...
* The original package name 'com.github.drnow4u.mcp.mcp-server' is invalid and this project uses 'com.github.drnow4u.mcp.mcp_server' instead.
...
```
$ docker run --rm -p 8080:8080 mcp-server:0.0.1-SNAPSHOT
```
